...
#mv cities.txt Cities.txt
  def up
    ...
    execute "COPY regions FROM '#{Rails.root}/db/migrate/Regions.txt' STDIN DELIMITER ',' CSV HEADER;"
    execute "COPY cities FROM '#{Rails.root}/db/migrate/Cities.txt' STDIN DELIMITER ',' CSV HEADER;"
